...
public class PenjualanAdapter extends RecyclerView.Adapter<PenjualanAdapter.ViewHolder> {
    ...
    public PenjualanAdapter(Context context, List<String> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.listpenjualan, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            myTextView = itemView.findViewById(R.id.kode_barang);
